The HTML for [Style Stage](https://stylestage.moderncss.dev) was created to be semantic, accessible, and free of nearly all other opinions. While typically extra divs are to be avoided, each sectioning element
